...
The project is in Phase 2 chapter and repository production. The Phase 2 foundation and Chapter 1 companion artifacts are on `main`. The Chapter 2 companion artifacts are under review.
...
- `manuscript/chapters/`: production notes only, not complete commercial chapter manuscripts.

The complete commercial manuscript, publisher layouts, and book-exclusive assets are maintained outside the public repository. See `docs/project/MANUSCRIPT-REPOSITORY-BOUNDARY.md`.
...
This is a multi-license repository. Executable material is Apache-2.0, project documentation and diagrams are CC BY 4.0, and limited publication-planning material is separately copyrighted. The complete commercial manuscript is not part of the active public tree. See `LICENSE`, `LICENSE-SCOPE.md`, and `docs/project/MANUSCRIPT-REPOSITORY-BOUNDARY.md` before reusing content.
